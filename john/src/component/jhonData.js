const jhonData = {
  ...
  aboutme: "About Me",
  aboutdetails:
    `Full Stack JavaScript Developer with more than 1 years of experience in the designing of complex Software’s,
    web and mobile applications, for the delivery of high-quality applications that meet all business needs.
    Thesis-project encompassed all the technologies learned throughout the program from front
    to back end and cloud deployment.`,
  service: [
    {
      id: 1,
      ...
      menuItems: [
        {
          id: 1,
          icon: "icon_pin_alt",
          text: "Address: 203 krickland avenue, Fairfield IA 52556",
        },
        {
          id: 2,
          icon: "icon_phone",
          text: "Phone: +1 202-554-6271",
        },
        {
          id: 3,
          icon: "icon_mail",
          text: "Email:lasmelash@miu.edu",
        },
        {
          id: 4,
          icon: "icon_globe",
          text: "Website: www.luwam.com",
        },
      ],
    },
  ],
